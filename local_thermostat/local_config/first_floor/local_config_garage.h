 ...
 */
uint8_t MAC_ADDRESS[] = { 0xDC, 0xA6, 0x32, 0x25, 0x1D, 0x17 };
 ...
 */
IPAddress IP(192, 168, 2, 17);		// *** CHANGE THIS to something relevant for YOUR LAN. ***
...
const float TEMPERATURE_CORRECTION = 2.5;