 ...
 */
uint8_t MAC_ADDRESS[] = { 0xDC, 0xA6, 0x32, 0x25, 0x1D, 0x23 };
 ...
 */
IPAddress IP(192, 168, 11, 23);		// *** CHANGE THIS to something relevant for YOUR LAN. ***
...
String roomName = "corridor-and-toilet";
