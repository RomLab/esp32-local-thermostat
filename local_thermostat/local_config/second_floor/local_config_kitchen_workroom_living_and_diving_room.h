 ...
 */
uint8_t MAC_ADDRESS[] = { 0xDC, 0xA6, 0x32, 0x25, 0x1D, 0x22 };
 ...
 */
IPAddress IP(192, 168, 11, 22);		// *** CHANGE THIS to something relevant for YOUR LAN. ***
...
String roomName = "kitchen-workroom-living-and-diving-room";
...
const float TEMPERATURE_CORRECTION = 5;